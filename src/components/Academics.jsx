...
const ACADEMICS_DATA = [
  {
    logo: "/assets/logos/manit.png",
    alt: "MANIT Bhopal Logo",
    link: "https://www.manit.ac.in/",
    title: "Maulana Azad National Institute of Technology (MANIT), Bhopal",
  ...
  {
    logo: "/assets/logos/sanskar.png",
    alt: "Sanskar Professional Studies Logo",
    link: "https://sanskarcollege.com/",
    title: "Sanskar Professional Studies, Indore",
    ...
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center px-4 py-12">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
          ...
          >
            I am currently pursuing my Master of Computer Applications (MCA) from
            MANIT Bhopal, where I am strengthening my knowledge of Full Stack Web
            Development, Data Structures & Algorithms, and Software Engineering.
            Previously, I completed my Bachelor's degree in Computer Science from
            Sanskar Professional Studies, Indore, building a strong foundation in
            programming, databases, and modern web technologies.
          </motion.p>
        </motion.div>
