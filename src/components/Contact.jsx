...
function ContactComponent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xjgngbzr", {
        method: "POST",
    ...
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center px-4 py-12">
      ...
      >
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            Looking for a MERN Stack Developer or want to collaborate on an exciting project? Feel free to reach out. Whether it's a job opportunity, freelance work, or just a tech discussion, I'd be happy to connect with you.
            </p>
        </motion.div>
