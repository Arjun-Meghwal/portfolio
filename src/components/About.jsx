...
const RESUME_URL =
  "https://drive.google.com/file/d/1dzKQhIpXo3Z0qzZwD8-AkwIYygfy9efX/view?usp=drivesdk";
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-5xl px-4 py-12">
        ...
        <motion.div
          ...
          tabIndex={0}
          aria-label="Profile photo of Arjun Meghwal"
        >
          <img
        ...
        >
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 text-muted-foreground text-sm mb-2">
            ...
            <span>MCA • MANIT Bhopal</span>
          </div>

          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-4 text-center md:text-left">
            I'm a passionate <span className="text-foreground font-medium">Full Stack MERN Developer</span> and MCA student at MANIT Bhopal. I enjoy building scalable, responsive and user-friendly web applications using React.js, Node.js, Express.js and MongoDB.

            {/* <br /><br />

            My major project <span className="text-foreground font-medium">StudyNotion</span> is a full-featured Learning Management System that includes JWT authentication, OTP verification, instructor dashboard, Razorpay payment integration and Cloudinary media uploads.

            <br /><br /> */}

            {/* I have also developed an <span className="text-foreground font-medium">Electric Vehicle Battery Health Prediction</span> system using Machine Learning to estimate battery health and driving range. */}

            {/* <br /><br /> */}

            {/* Along with Full Stack Development, I actively practice Data Structures & Algorithms in C++ and continuously improve my problem-solving skills through LeetCode. */}
          </p>
