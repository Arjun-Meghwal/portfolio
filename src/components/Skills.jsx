...
const SKILLS_SECTIONS = [
    ...
    { icon: <Layers className="w-6 h-6" />, title: "Frameworks & Libraries", tags: ["React", "Tailwind CSS", "NumPy", "Pandas"] },
    { icon: <Terminal className="w-6 h-6" />, title: "Tools &s", tags: ["Git", "GitHub", "VS Code", "Jupyter Notebook" ] },
